...
{
    public class Mach1EncodePlugin : ModuleRules
    {
        ...
        public Mach1EncodePlugin(ReadOnlyTargetRules Target) : base(Target)
        {
            ...
            // Force compilation of all source files without unity builds
            bUseUnity = false;
        }
    }
} 